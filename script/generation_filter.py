...
# In[]
# directory = r"D:\Lab\project\paper\BioAug-main\datasets-precompute\tarced_f\3_dis5\inference_ver"
# filename = "model_1_train6_inference_ver_large"

args.input_file = args.input_file + ".json"
with open(os.path.join(args.directory,args.input_file), 'r') as f:
...
for idx, old_id in enumerate(old_id_list):
    # break
    target_id_data_list = []
    target_id_data_list = [gene['id'] for gene in generation_data if gene['origin_id'] == old_id]
...
# In[]
# final_generation_list = final_generation_list + mix_id_list
# output_file_path = r"{}\{}.json".format(args.directory, args.output_file)
