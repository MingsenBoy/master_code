...
import os
# new_working_directory = r'D:\Lab\project\paper\bioaug4re\script'
...
# In[]
def add_relation_mentions(sketch, original_text, id, verbalized_relation, full_train, full_dev):
    if 'train' in id:
    ...
    ver_relation = verbalized_relation[verbalized_relation_id]['verbalize_result']
...
# args.template = "tacred_template_relation"
...
class DataCollatorForSeq2Seq:
    ...
    def __call__(self, features, return_tensors=None):
        ...
        for i in range(len(text)): # for ever datapoint in a batch
            ...
            generated_sketch = add_relation_mentions(new_text, original_text, id[i], verbalized_relation, full_train, full_dev)
...
if args.directory[-1]!='/':
    args.directory += '/'
#args.train_file = "train_processed"
output_dir = f"{args.train_file}-{args.file_name}"
